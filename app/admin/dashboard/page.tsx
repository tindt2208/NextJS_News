...
import ArticlesTable from "@/app/admin/components/ArticlesTable"


const articles = [...Array(20)].map(() => {
    return {
        id: Math.random().toString(),
        title: "Insomniac Games quá tập trung vào các trò chơi Marvel sẽ gây hậu quả xấu về sau?",
        short_content: "Insomniac Games quá tập trung vào các trò chơi Marvel sẽ gây hậu quả xấu về sau?",
        content: "",
        category: "ABCD",
        image_url: "",
        total_viewed: 123,
    ...
    return (
        <div className="flex h-screen bg-white">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                {/* Page content */}
                <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200 p-8 rounded-lg">
                    ...
                    <div className="flex flex-wrap my-6 -mx-3 px-3">
